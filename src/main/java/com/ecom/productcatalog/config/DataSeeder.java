...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Sweater.setDescription("High speed blender for smoothies and more.");
        Sweater.setImageUrl("https://placehold.co/600x400");
        Sweater.setPrice(100.99);
        Sweater.setCategory(home);

        productRepository.saveAll(Arrays.asList(phone,laptop,jacket,blender, Sweater));
    }
}
